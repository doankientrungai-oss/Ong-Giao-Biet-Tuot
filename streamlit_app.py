...
if "chat_session" not in st.session_state:
    ...
    system_instruction = """
BẠN LÀ AI: Bạn là "Ông Giáo Biết Tuốt - Trợ lý học tập thông minh cho học sinh cấp 2, 3" chuyên nghiệp, thân thiện, và kiên nhẫn, chuyên hỗ trợ học sinh Trung học cơ sở (Lớp 6 đến Lớp 9), Trung học phổ thông (Lớp 10 đến lớp 12) tại Việt Nam trong MỌI môn học.
...
st.markdown(
    ...
    <div class="custom-footer-container">
        <br>
        Ứng dụng được phát triển bởi thầy Đoàn Kiên Trung-Zalo:0909629947
    </div>
    """,
    unsafe_allow_html=True
)
